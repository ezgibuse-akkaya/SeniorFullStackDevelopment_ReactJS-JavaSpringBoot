package com.isikezgibuse.seniorfullstack1.business.services;


import com.isikezgibuse.seniorfullstack1.bean.ModelMapperBean;
import com.isikezgibuse.seniorfullstack1.business.dto.BlogCategoryDto;
import com.isikezgibuse.seniorfullstack1.business.services.impl.IBlogCategoryServices;
import com.isikezgibuse.seniorfullstack1.data.entity.BlogCategoryEntity;
import com.isikezgibuse.seniorfullstack1.data.repository.IBlogCategoryRepository;
import com.isikezgibuse.seniorfullstack1.exception.EzgiBuseIsikException;
import com.isikezgibuse.seniorfullstack1.exception.NotFound404Exception;
...
public class BlogCategoryServicesImpl implements IBlogCategoryServices<BlogCategoryDto, BlogCategoryEntity> {
    ...
    */
    ...
    public BlogCategoryDto entityToDto(BlogCategoryEntity blogCategoryEntity) {
        return modelMapperBeanClass.getModelMapperMethod().map(blogCategoryEntity, BlogCategoryDto.class);
    }

    @Override
    public BlogCategoryEntity dtoToEntity(BlogCategoryDto categoryDto) {
        return modelMapperBeanClass.getModelMapperMethod().map(categoryDto, BlogCategoryEntity.class);
    }
    ...
    public BlogCategoryDto categoryServiceFindById(Long id) {
        ...
        */
        ...
        if (id != null) {
            ...
            throw new EzgiBuseIsikException("İd null olarak geldi");
        }
